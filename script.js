window.onload = function(){
    ...
    alert('Hello\nGood day. And use the moon or sun icon at the top right corner of the screen to toggle between nightmode and daymode\nBot created by\nRahul')
...
responses['who are you?'] ='I am a ChatBot programmed using computer by my master Rahul',
responses['😂']='🤭🤣🤣🤣🤣'
...
function searchWebForResponse(message) {
    return 'Sorry, I was unable to find a response for your message on the web or my Creator Rahul did not grant me permission to do so. Could you please rephrase it?';
}
}